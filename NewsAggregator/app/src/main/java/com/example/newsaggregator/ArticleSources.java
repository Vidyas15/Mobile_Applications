...
public class ArticleSources implements Runnable {
    ...
    public ArticleSources(MainActivity mainActivity, String id) {
    ...
    public void run() {
        ...
        try {
            URL url = new URL(newsURL+"?sources="+id+"&apiKey=9fb74d8a1ba64942aeece6c89543841f");
